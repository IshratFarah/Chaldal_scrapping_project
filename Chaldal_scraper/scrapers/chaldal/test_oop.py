...
class DataRetriever:
    ...
    def find_product_description(self, product_link):
        detail_link = self._handler.url_home + product_link
    ...
    def get_product_info(self, soup, menubar):
        ...
        try:
            ...
            df_sub = self._get_url(sub_link_container)
...
class Main:
    ...
    def executor(self):
        menu_link_container = self.driver.find_elements(By.CSS_SELECTOR, "ul[class*='level-']")
